...
# Automated Release Script for Pluk
...
echo "  - Tag: $TAG_NAME"
echo "  - DMG: $DMG_NAME"
echo "  - GitHub: GitHub: https://github.com/pluk-sh/app-pluk/releases/tag/$TAG_NAME"
echo ""
...
# if "$SCRIPT_DIR/upload-to-r2.sh" "$DMG_PATH" "$RELEASE_VERSION" "$RELEASE_TYPE"; then
...
#     echo "   $SCRIPT_DIR/upload-to-r2.sh \"$DMG_PATH\" \"$RELEASE_VERSION\" \"$RELEASE_TYPE\""
# fi
