...
private enum AppleCardScene {
    ...
    private static func engravedOverlayImage(displayName: String, sinceYear: String, isDark: Bool) -> NSImage {
        ...
        // Top-left: "PLUK PRO" tier label (small, matches SINCE styling)
        ...
        // Top-right: SINCE year — cap center matches PLUK PRO
        drawEngravedText(
            "SINCE \(sinceYear)",
            at: CGPoint(x: margin, y: drawY(forCapCenter: topCapCenter, font: tierFont)),
            font: tierFont,
        ...
        // Directly below PLUK PRO: display name (prominent)
        ...
        // Bottom-left: Pluk logo + wordmark
