//
//  TableController.backup.swift
//  Pluk
//
//  Created by Fauzaan on 6/6/25.
//
...
// MARK: - Legacy NSViewController implementation (kept for reference)
class TableListViewControllers: NSViewController {
...
extension TableListViewControllers: NSTableViewDelegate {
    func tableView(_ tableView: NSTableView, viewFor tableColumn: NSTableColumn?, row: Int) -> NSView? {
        return NSTextField(labelWithString: "Test")
...
//        var cellView = tableView.makeView(withIdentifier: CellIdentifier.textCell, owner: self) as? NSTableCellView
...
////        )
//
//        cellView?.textField?.stringValue = "Testingf"
//
//        return cellView
    }
//
