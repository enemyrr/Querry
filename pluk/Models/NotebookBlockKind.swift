...
enum NotebookBlockKind: String, Codable, CaseIterable {
    ...
    var aiTool: OpenAIChatCompletionRequestBody.Tool? {
        guard isAICreatable else { return nil }
        switch self {
    ...
    static var allAITools: [OpenAIChatCompletionRequestBody.Tool] {
    ...
    private static let chartTool = OpenAIChatCompletionRequestBody.Tool.function(
    ...
    private static let textTool = OpenAIChatCompletionRequestBody.Tool.function(
